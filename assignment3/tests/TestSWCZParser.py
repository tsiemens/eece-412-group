...
class TestSWCZParser(unittest.TestCase):
    ...
    def test_Integer_not(self):
        try:
            result = Integer.parser().parse_string('abc', eof=True)
            self.fail()
        except:
            pass
    ...
    def test_Double_not(self):
        try:
            result = Double.parser().parse_string('abc', eof=True)
            self.fail()
        except:
            pass
    ...
    def test_Double_int(self):
        try:
            result = Double.parser().parse_string('123', eof=True)
            self.fail()
        except:
            pass
    ...
    def test_IntProp_noval(self):
        try:
            result = IntProp.parser().parse_string("p=,", eof=True)
            self.fail()
        except:
            pass   
    ...
    def test_IntProp_noname(self):
        try:
            result = IntProp.parser().parse_string("=4,", eof=True)
            self.fail()
        except:
            pass
    ...
    def test_IntProp_noname(self):
        try:
            result = IntProp.parser().parse_string("=4,m=4", eof=True)
            self.fail()
        except:
            pass

    def test_InitClient(self):
        result = InitClause.parser().parse_string("INITC:p=4 , g=9,A=45", eof=True)
    ...
    def test_InitMsg(self):
        result = InitMsgHeader.parser().parse_string("SWCZ/1.0; INITC:p=4 , g=9,A=45", eof=True)
        self.assertEquals(result.init_clause().props(), {'p':4, 'g':9, 'A':45})
